...
const ShiftStatus = ({ shiftData, shiftId, staffSummaryDetails }: any) => {
  const navigate = useNavigate();

  const handleCardClick = (id: string, type: string) => {
    switch (type) {
      case "Open shifts":
        navigate(`/staff-manager/staff-summary/open-shift/${shiftId}`, { state: staffSummaryDetails });
        break;
      case "Total Hours Life Time":
        navigate(`/staff-manager/staff-summary/total-hours-life-time`);
        break;
      case "Confirmed shifts":
        navigate(`/staff-manager/staff-summary/confirmed-shift`, { state: staffSummaryDetails });
        break;
      case "Total Hours This Month":
        navigate(`/staff-manager/staff-summary/total-hours-month`);
        break;
      case "Completed shifts":
        navigate(`/staff-manager/staff-summary/completed-shift`, { state: staffSummaryDetails });
        break;
      default:
        break;
    }
