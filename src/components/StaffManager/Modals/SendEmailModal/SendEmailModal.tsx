      ...
      >
        <div className="staff-email-send-content d-flex flex-column">
          <div className="input-field">
            <Input onChange={(e: any) => handleSendEmail(e.target.value, "emailId")} placeholder="david@email.com" type="email" size="large" className="fs-14 fw-400 title-color line-heigth-22" />
          </div>
