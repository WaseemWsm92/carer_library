...
const CarerCordinator = () => {
  ...
  if (isLoading) {
    carerCordinatorData = <p>Loading...</p>;
  } else if (isSuccess) {
                  ...
                  <Col xs={24} sm={8}>
                    ...
                    <div className="filter-column">
                      <Select
                        ...
                        options={[
                          {
                            value: "Tall Tree Care Home",
                            label: "Tall Tree Care Home",
                          },
                          {
                            value: " Tree Care Home",
                            label: " Tree Care Home",
                          },
                          {
                            value: "Ivy Grove Care Home",
                            label: "Ivy Grove Care Home",
                          },
                        ]}
                      />
                    </div>
                  ...
                  <Col xs={24} sm={8}>
                    ...
                    <div className="filter-column">
                      <Select
                        ...
                        popupClassName="app-select-popup-wrap-class"
                        options={[
                          { value: "03/12/2021", label: "03/12/2021" },
                          { value: "03/12/2018", label: "03/12/2018" },
                          { value: "03/12/2021", label: "03/12/2020" },
                        ]}
                      />
                    </div>
                  </Col>
