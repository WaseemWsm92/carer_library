    ...
    {isSuccess?  <div>
      ...
      <Row gutter={[20, 12]}>
        ...
        <Space direction='vertical' size={0}>
                ...
                <span className='fw-400 fs-12'>
                  {profileViewData?.data?.userprofile?.personalInformation?.dob}
                </span>
              </Space>
        </Col>
        <Col xxl={8} xs={24}>
      ...
      <Row gutter={[10, 10]}>
        ...
        <Col xs={24} >
          <Space direction='vertical' size={0}>
            ...
            <span className='fw-400 fs-12'>   {profileViewData?.data?.userprofile?.updatedAt
}</span>
...
{profileViewData?.data?.userprofile?.idProof?
      <div>
        <Space size={3} direction='vertical'>
          ...
          <Space size={3} className='d-flex align-center'> <span className='d-flex align-center'><a href={`https://rnd-s3-public-dev-001.s3.eu-west-2.amazonaws.com/${profileViewData?.data?.userprofile?.idProof?.mediaId
}.${profileViewData?.data?.userprofile?.idProof?.mediaMeta?.extension}`}><img src={Pdf} alt="" /></a></span> <span className='fw-400 fs-12' >doc.pdf</span></Space>
        </Space>
      </div> :"No Attachments"}
