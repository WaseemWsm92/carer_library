...
const OtherInformation = ({selectedTableData}:any) => {
  const {data,isLoading,isSuccess,isError}=useGetRequestByIdQuery({id:selectedTableData,detail:"OTHERINFO"})
...
?.employmentStatus?.empDetails?.payTaxCode}
              </Space>
            </Space>      
        </Col>
        <Col xs={12}>
...
?.employmentStatus?.empDetails?.p45TaxYear ? "Yes" :"No"}
        ...
        <Col xs={12}>
          ...
          National Insurance No
              ...
              <Space  size={6}>
                {profileViewInfoData?.data?.userprofile
?.employmentStatus?.empDetails?.insuranceNo}
              </Space>
            </Space>      
        </Col>
        <Col xs={12}>
          ...
          Do you have one of the student loans?
              ...
              <Space  size={6}>
                {profileViewInfoData?.data?.userprofile
?.employmentStatus?.empDetails?.studentLoan ? "Yes" :"No"} 
              </Space>
            </Space>      
        </Col>
        <Col xs={12}>
...
?.employmentStatus?.empDetails?.documents}
              </Space>
            </Space>      
        </Col>
        <Col xs={12}>
...
?.employmentStatus?.empDetails?.postGraduateLoan}</span>
