...
const EmployementStatus = (props: any) => {
    ...
    const [repaidLoan, setRepaidLoad] = useState(profileViewInfoData?.data?.userprofile?.employmentStatus?.empDetails?.repaidLoan)
  ...
  const payloadEmployeeStatusPaye={
    ...
    // FromDate:dayjs(profileViewInfoData?.data?.userprofile?.employmentStatus?.empDetails?.FromDate),
    // ToDate:dayjs(profileViewInfoData?.data?.userprofile?.employmentStatus?.empDetails?.ToDate),
  }
   ...
   const payloadEmployeeStatusLimited={
    ...
    const onFinishPaye = (values: any) => {
        ...
        postOtherInformationRequest({payload:{employmentStatus:payloadEmployeeStatus},id:state?.editProfile?._id})
