...
const RightToWork = (props: any) => {
  ...
  const token: any = JSON.parse(userData);
    ...
    const onFinish = (values: any) => {
        const payloadRightToWork={...values , certificates: certificateId}
        postBckgroundChecksRequest({payload:{rightToWork:payloadRightToWork},id:state?.editProfile?._id })
      ...
      {isSuccess?  <div >
            ...
            >
                <Row gutter={[30, 5]} align="bottom">
                    ...
                    {value==="no" && <Col xs={24} sm={24} md={12} lg={10}>
                        <Form.Item
                            label="Visa Type "
                            name="visaType"
                    ...
                    {value==="no" && <Col xs={24} sm={24} md={12} lg={10} className='carer-form-input '>
                        <Form.Item
                    ...
                    {value==="no" && <Col xs={24} sm={24} md={12} lg={10} className='date-picker-wrapper'>
                    ...
                    {value==="no" && <Col xs={24} sm={24} md={12} lg={10} className='d-flex align-center' >
                        <Form.Item
                            label=""
                            name=""
                        >
                    ...
                    {value==="no" && <Col xs={24} lg={21}  ><span className='fw-500 fs-20'>Upload File</span></Col>}
                    {value==="no" && <Col xs={24} lg={21}  >
