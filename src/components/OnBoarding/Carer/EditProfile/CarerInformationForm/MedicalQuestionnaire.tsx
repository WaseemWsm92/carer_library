...
const MedicalQuestionnaire = (props: any) => {
 ...
 medicalSurvey.forEach(item => {
  ...
  const medicalQuestionnaire={...medicalInfoObject,...medicalSurayTextAreaInfo}
  console.log(medicalQuestionnaire)
  const handleImmunisation=()=>{
    updateRequest({id:state?.editProfile?._id,payload:{medicalQuestionnaire:medicalQuestionnaire}})
  }
    return (
