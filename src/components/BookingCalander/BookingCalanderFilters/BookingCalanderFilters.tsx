        ...
        <div className="inner-flex-filters">
          <div className="col-box">
            <div className="area-fliters">
              ...
              >
                <option value="" className=" title-color">All</option>
                {clientsList?.data?.result?.map((clientDetails: any) => (
                  <option value={clientDetails?._id}>{clientDetails?.clientName}</option>
                ))}
              </Select>
            </div>
          </div>
            ...
            <div className="area-fliters">
              ...
              >
                ...
                {staffList?.data?.result?.map((staffDetails: any) => (
                  <option value={staffDetails?._id}>{staffDetails?.firstName} {staffDetails?.lastName}</option>
                ))}
              </Select>
            </div>
          </div>}
