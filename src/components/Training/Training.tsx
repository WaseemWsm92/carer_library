  ...
  const dataCheckTraining = getTrainingCourseData?.data?.length
   ...
   const coursesInfoData: any = [
    ...
    },
    {
      ...
      details: [
        { icon: trainingGroupIcon, title: "Total Carers", count: `${dataCheck ? getTrainingCourseData?.data?.totalCourses : 'nan'}` },
        { icon: trainingNoteIcon, title: "Total Courses", count: `${dataCheck ? getTrainingCourseData?.data?.totalCourses : 'nan'}` },
      ],
      img: trainingIcon,
    },
  ];
