    ...
    <div className="certificate-card">
      <div className="certificate-details d-flex justify-between">
        <div className="content">
          ...
          <p className="date fs-18 fw-300">{dayjs(certificate?.certificateIssueDate).format('MMMM DD, YYYY')}</p>
          <div>
            <h4 className="name fw-500">{certificate?.firstName}&nbsp;{certificate?.lastName}</h4>
            <p className="info fs-18 fw-300 m-0">Sucessfully completed course of</p>
          </div>
          <div>
            <h2 className="certificate-name fw-500">{certificate?.courseName}</h2>
          ...
          <div className="signature">
            ...
            <h2 className="owner fs-20 fw-500">{certificate?.authorFirstName}&nbsp;{certificate?.authorLastName}</h2>
