...
//  console.log("state=>", state)
 ...
 const { data, isLoading, isError, isSuccess } = useGetCarerCoursesCompletedQuery({courseId:state?.courseId, carerId:state?.carerID})
        ...
        <Col xxl={12} xs={24}>
          <Row gutter={[20, 20]}>
            ...
            <Col xl={24} style={{ width: "100%" }}>
              <CertificateRating ratingData={getCetfificateData?.data?.rating} courseId={state?.courseId}/>
            </Col>
          </Row>
        </Col>
        <Col xxl={12} xs={24}>
