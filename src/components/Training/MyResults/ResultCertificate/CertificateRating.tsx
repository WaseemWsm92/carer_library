...
import { usePatchMyResultRatingMutation } from "../../../../store/Slices/Training";
...
const CertificateRating = ({ ratingData, courseId }: any) => {
  ...
  console.log("ratingNote", ratingNote)
  ...
  return (
    <div className="rating-card">
      ...
      <div className="rating">
        <Rate disabled={!editReview} onChange={setValue} defaultValue={ratingData?.rating} value={value} />
        {!editReview ? (
