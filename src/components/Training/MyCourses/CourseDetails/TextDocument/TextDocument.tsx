    ...
    <div className="text-document">
      ...
      <div className="description">
        ...
        {[1, 2, 3, 4, 5].map((item: number) => (
          <p key={item} style={{ color: "#4E4B66" }} className="fs-16 fw-400">
            The American Heart Association’s Basic Life Support (BLS) training reinforces healthcare
            professionals’ understanding of the importance of early CPR and defibrillation,
            performing basic steps of early CPR and defibrillation, performing basic steps of CPR,
