...
import { useDeleteStaffStatusMutation, useGetStaffStatusQuery, useUpdateStaffStatusMutation } from "../../../../store/Slices/Setting/StaffSettings/StaffStatus";
  ...
  const StaffStatusColumns: ColumnsType<DataType> = [
    ...
    },
    {
      ...
      render: (_:any, record:any) => (
        <SwitchWrapper
          name="Enable" checked={record?.enable}
  ...
  return (
    <div className='staff-status'>
      <div className="heading">
        <h1 className="fs-16 fw-600 m-0">Staff Status  </h1>
      </div>
