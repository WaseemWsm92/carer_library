...
const TicketsSummary = () => {
  ...
  const { data, isLoading, isSuccess, isError } = useGetTicketSummaryRequestQuery({ refetchOnMountOrArgChange: true });

  let ticketsSummaryData: any;
  if (isLoading) {
    ticketsSummaryData = <p>Loading...</p>;
  } else if (isSuccess) {
    ticketsSummaryData = data;
  } else if (isError) {
    ticketsSummaryData = <p>Error...</p>;
  }
