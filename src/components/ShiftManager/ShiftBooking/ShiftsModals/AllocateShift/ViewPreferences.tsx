  ...
  const viewPreferencesData = [
    {
      ...
      icon: ExperienceIcon,
      title: "Experience",
      desc: `${preferences[0]?.experience} Years` ,
    },
    {
      id: "2",
      icon: RadiusIcon,
      title: "Radius",
      desc: `${preferences[0]?.location} Miles` ,
    },
    {
      id: "3",
      icon: LanguageIcon,
      title: "Language",
      desc: preferences[0]?.language,
    },
    {
      id: "4",
      icon: GenderIcon,
              ...
              {viewPreferencesData.map((item: any) => (
               ...
               <Col xl={24} lg={24} md={24} sm={24} xs={24}>
                            <div className='view-preference-btn'>
                                <button type='button' className='fs-16 fw-600 line-height-22 white-color m-0 cursor-pointer' style={{}}>Find Match</button>
                            </div>
                            </Col>
            </Row>
          </div>
