...
const AdvanceStaffSearch = (props: any) => {
  ...
  const handleAdvanceFilter = () => { 
    console.log(advanceStaffSearchData)
  }
        ...
        <Row gutter={[40, 40]}>
          <Col xl={12} lg={12} md={12} sm={24} xs={24}>
                  ...
                  <div className="search-client-vaccination">
                    <SelectWrapper
                      ...
                      options={[
                        ...
                        { label: "Measles, mumps and rubella(MMR)", value: "measles, mumps and rubella" },
                        { label: "Annual Influenza Vaccine", value: "annual influenza vaccine" },
                        { label: "Covid Vaccination", value: "covid vaccination" },
                        { label: "Bacillus Calmette-Guerin(BCG)", value: "bacillus calmette-guerin" },
                      ]}
            ...
            <div className="advance-staff-btn">
              <button type="button" onClick={handleAdvanceFilter} className="fs-16 fw-600 line-height-22 white-color">
                Apply Search
              </button>
            </div>
          </Col>
