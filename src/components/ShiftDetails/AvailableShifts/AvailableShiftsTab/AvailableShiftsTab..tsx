...
import { useGetRequestQuery, usePostAcceptShiftRequestMutation } from '../../../../store/Slices/ShiftDetails';
...
const AvailableShiftsTab = () => {
  const { data, isLoading, isSuccess, isError, } = useGetRequestQuery({ refetchOnMountOrArgChange: true })
