...
const ClientSignOffShift = () => {
  ...
  return (
    <>
      ...
      <ConfirmModal isCompletedConfirmModal={isCompletedConfirmModal} setIsCompletedConfirmModal={setIsCompletedConfirmModal} shiftIdData={shiftIdData} />
      <ModifyModal isCompletedModifyModal={isCompletedModifyModal} setIsCompletedModifyModal={setIsCompletedModifyModal} shiftIdData={shiftIdData} />
    </>
  )
}
