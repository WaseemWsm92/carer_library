...
//Main
export const ClientCard = ({recruitmentStats,isLoading}:any) => {
  return (
    ...
    <Card className="most-used-services-card  border-radius-8 card card-bg-color" bordered={false}  style={{boxShadow: "0px 1px 6px rgba(0, 0, 0, 0.15)",minHeight:"400px"}}>
      ...
      {isLoading ? <div style={{ textAlign: "center", paddingTop: "30px" }}><Spin indicator={<LoadingOutlined style={{ fontSize: 36 }} spin />} /></div> : <RecruitmentGraph recruitmentStats={recruitmentStats}/>}
