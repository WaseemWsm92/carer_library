  ...
  return (
    <Layout className="dashboard bg-unset">
      ...
      >
        ...
        {isLoading ? <div style={{ textAlign: "center", paddingTop: "30px" }}><Spin indicator={<LoadingOutlined style={{ fontSize: 36 }} spin />} /></div> : <StaffStatusGraph staffStatusStats={staffStatusStats} />}
