...
const ManageDepartmentsForm = (props: any) => {
  ...
  // api start
  const { data, isLoading, isSuccess, isError, } = useGetManageDepartmentQuery({ userId: state?.editProfile?._id })  // get table data
  ...
  const onFinish = (values: any) => {
    ...
    postManageDepartments({ userId, payload: formValues });
