                ...
                <div className="form-progress">
                    <div>
                        <div className='fs-14 fw-400 title-color' style={{ minWidth: "70px" }}>
                            <span className='fw-700 fs-14'>{state?.editProfile?.percentageComplete}%</span>
                            <span style={{ marginLeft: "5px" }} className='fw-600 fs-14'>Done</span>
                        </div>
                        <Progress percent={state?.editProfile?.percentageComplete} strokeColor='#F7B923' strokeWidth={9} width={50} showInfo={false} /></div>
                </div>
            </div>
