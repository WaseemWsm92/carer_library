...
const AttendanceReportDetailsFilters = () => {
                ...
                <Row gutter={[30, 30]} className="extra-cards-parent">
                    <Col xs={24} md={12} xl={8}>
                        <Space size={16} className="extra-cards">
                            ...
                            <div>
                                <p className='fs-20 fw-500 line-height-28 m-0 extra-card-heading' style={{ color: "#00AC4F" }}>538.5</p>
                    ...
                    <Col xs={24} md={12} xl={8}>
                        <Space size={16} className="extra-cards">
                            ...
                            <div>
                                <p className='fs-20 fw-500 line-height-28 m-0 extra-card-heading' style={{ color: "#8B44FD" }}>35.35</p>
                    ...
                    <Col xs={24} md={12} xl={8}>
                        <Space size={16} className="extra-cards">
                            ...
                            <div>
                                <p className='fs-20 fw-500 line-height-28 m-0 extra-card-heading' style={{ color: "#B50097" }}>02</p>
                    ...
                    <Col xs={24} md={12} xl={8}>
                        <Space size={16} className="extra-cards">
                            ...
                            <div>
                                <p className='fs-20 fw-500 line-height-28 m-0 extra-card-heading' style={{ color: "#FB1D1D" }}>35.35</p>
