...
const ClientDetailsPage = Loadable(lazy(() => import("./pages/Onboarding/CareCoordinator/ClientDetails")));
...
const ClientRegistration = Loadable(lazy(() => import("./pages/ClientManager/ClientRegisteration")));
const ManageGroups = Loadable(lazy(() => import("./pages/ClientManager/ManageGroups")));


//Onboarding
const CarerPage = Loadable(lazy(() => import("./pages/Onboarding/Carer")));
const CareCoordinatorPage = Loadable(lazy(() => import("./pages/Onboarding/CareCoordinator")));
const TrainingInstructorPage = Loadable(lazy(() => import("./pages/Onboarding/TrainingInstructor")));

const CarerEditProfilePage = Loadable(lazy(() => import("./pages/Onboarding/Carer/EditProfile")));
const CareCoordinatorEditProfilePage = Loadable(lazy(() => import("./pages/Onboarding/CareCoordinator/EditProfile")));
const TraingingInstructorEditProfilePage = Loadable(lazy(() => import("./pages/Onboarding/TrainingInstructor/EditProfile")));
...
const InvoiceCareHomePage = Loadable(lazy(() => import("./pages/Finance/Invoice/InvoiceCareHome")));
const InvoiceWeeksPage = Loadable(lazy(() => import("./pages/Finance/Invoice/InvoiceWeeks")));
const InvoiceWeeksDetailPage = Loadable(lazy(() => import("./pages/Finance/Invoice/InvoiceWeeksDetails")));
const InvoiceStaffDetailPage = Loadable(lazy(() => import("./pages/Finance/Invoice/InvoiceStaffDetails")));
...
const StaffManagerSummary = Loadable(lazy(() => import("./pages/StaffManager/StaffManagerSummary")));
const StaffManagerOpenShift = Loadable(lazy(() => import("./pages/StaffManager/ShiftStatus/OpenShiftStatus")));
const StaffManagerTotalHours = Loadable(
  lazy(() => import("./pages/StaffManager/ShiftStatus/TotalHoursLifeTime"))
);
const StaffManagerConfirmedShift = Loadable(lazy(() => import("./pages/StaffManager/ShiftStatus/ConfirmedShift")));
const StaffManagerTotalHoursMonth = Loadable(
  lazy(() => import("./pages/StaffManager/ShiftStatus/TotalHoursThisMonth"))
);
const StaffManagerCompletedShift = Loadable(lazy(() => import("./pages/StaffManager/ShiftStatus/CompletedShift")));
...
const AvailableShift = Loadable(lazy(() => import("./pages/StaffBooking/AvailableShift")));
const UpComingShift = Loadable(lazy(() => import("./pages/StaffBooking/UpComingShift")));
const CompletedShift = Loadable(lazy(() => import("./pages/StaffBooking/CompletedShift")));
const WorkHistory = Loadable(lazy(() => import("./pages/StaffBooking/WorkHistory")));
...
const ShiftManagerDetails = Loadable(lazy(() => import("./pages/ShiftManager/ShiftBooking")));
const ShiftManagerConfirmedShift = Loadable(lazy(() => import("./pages/ShiftManager/ShiftBooking/ConfirmedShift")));
const ShiftManagerUnfilledShift = Loadable(lazy(() => import("./pages/ShiftManager/ShiftBooking/UnfilledShift")));
const ShiftManagerUnPublishedShift = Loadable(lazy(() => import("./pages/ShiftManager/ShiftBooking/UnPublishedShift")));
const ShiftManagerBookStaff = Loadable(lazy(() => import("./pages/ShiftManager/ShiftBooking/UnPublishedShift/BookStaff")));
const UnpublishedShiftPage = Loadable(lazy(() => import("./pages/UnpublishedShift")));
const BookStaffPage = Loadable(lazy(() => import("./pages/UnpublishedShift/BookStaff")));
const FinancePage = Loadable(lazy(() => import("./pages/Finance/Finance")));
const SetupPage = Loadable(lazy(() => import("./pages/Finance/Setup")));
const FinanceReportsPage = Loadable(lazy(() => import("./pages/Finance/Reports")));
const FinanceReportsStaffHoursPage = Loadable(lazy(() => import("./pages/Finance/Reports/StaffHours")));
const FinanceReportsNIPaymentPage = Loadable(lazy(() => import("./pages/Finance/Reports/NIPayment")));
const FinanceReportsNonNIPaymentPage = Loadable(lazy(() => import("./pages/Finance/Reports/NonNiPayment")));
const FinanceReportsLimitedPage = Loadable(lazy(() => import("./pages/Finance/Reports/Limited")));
const FinanceReportsShiftSummaryPage = Loadable(lazy(() => import("./pages/Finance/Reports/ShiftSummary")));
const FinanceReportsShiftSummaryDatilPage = Loadable(lazy(() => import("./pages/Finance/Reports/ShiftSummaryDetail")));
const FinanceReportsContractorPaymentPage = Loadable(lazy(() => import("./pages/Finance/Reports/ContractorPayment")));
const InvoicePage = Loadable(lazy(() => import("./pages/Finance/Invoice")));
const StaffPaymentDetailsPage = Loadable(lazy(() => import("./pages/Finance/StaffPaymentDetails")));
const ClientPaymentDetailsPage = Loadable(lazy(() => import("./pages/Finance/ClientPaymentDetails")));

// Reports and its Child Routes Starts Here
const ReportsMainPage = Loadable(lazy(() => import("./pages/Reports")));
const ActivityReport = Loadable(lazy(() => import("./pages/Reports/ActivityReport")));
...
const ExtraHoursReport = Loadable(lazy(() => import("./pages/Reports/ExtraHourReport")));
const GrossProfitLoss = Loadable(lazy(() => import("./pages/Reports/GrossProfitLoss")));
...
const ShiftBooking = Loadable(lazy(() => import("./pages/Reports/ShiftBooking")));
const ShiftCancelled = Loadable(lazy(() => import("./pages/Reports/ShiftCancelled")));
const StaffData = Loadable(lazy(() => import("./pages/Reports/StaffData")));
const ShiftRateSetting = Loadable(lazy(() => import("./pages/Reports/ShiftRateSetting")));
const StaffAttendance = Loadable(lazy(() => import("./pages/Reports/StaffAttendance")));
const StaffAvailability = Loadable(lazy(() => import("./pages/Reports/StaffAvailability")));
const StaffCompliance = Loadable(lazy(() => import("./pages/Reports/StaffCompliance")));
const StaffReport = Loadable(lazy(() => import("./pages/Reports/StaffReport")));
const StaffShiftHours = Loadable(lazy(() => import("./pages/Reports/StaffShiftHours")));
const StaffWork = Loadable(lazy(() => import("./pages/Reports/StaffWork")));
const TerminatedStaff = Loadable(lazy(() => import("./pages/Reports/TerminatedStaff")));
const Vaccination = Loadable(lazy(() => import("./pages/Reports/Vaccination")));
const TraineesInfo= Loadable(lazy(() => import("./pages/Reports/TraineesInfo")));
const WebinarsReport= Loadable(lazy(() => import("./pages/Reports/WebinarsReport")));
const CertificateReport= Loadable(lazy(() => import("./pages/Reports/CertificateReport")));
const Finance= Loadable(lazy(() => import("./pages/Reports/Finance")));


const IncidentReport = Loadable(lazy(() => import("./pages/Reports/IncidentReport")));
const RatingsReport = Loadable(lazy(() => import("./pages/Reports/RatingsReport")));
...
const CoursesDetail = Loadable(lazy(() => import("./pages/ManageCourses/CourseDetails")));
const AddCourses = Loadable(lazy(() => import("./pages/ManageCourses/AddCourse")));
const TraineeInfo = Loadable(lazy(() => import("./pages/TraineeInfo")));
const TraineeCourses = Loadable(lazy(() => import("./pages/TraineeInfo/TraineeCourses")));

const Webinars = Loadable(lazy(() => import("./pages/Webinars/UpcomingWebinar")));

const RequestedAttendees = Loadable(lazy(() => import("./pages/Webinars/UpcomingWebinar/RequestedAttendees")));

const WebinarHistory = Loadable(lazy(() => import("./pages/Webinars/WebinarHistory")));
const ViewDetails = Loadable(lazy(() => import("./pages/Webinars/WebinarHistory/ViewDetails")));
...
const ItHelpDeskAllTicketsPage = Loadable(lazy(() => import("./pages/Help/ItHelpDesk/AllTickets/AllTickets")));
...
// );
const ItHelpDeskSupportDashboard = Loadable(lazy(() => import("./pages/Help/ItHelpDesk/SupportDashboard/SupportDashboard")));
...
const ClientCalendarShiftDetails = Loadable(lazy(() => import("./pages/ClientBookingCalendar/BookingShiftDetails")));
...
export const routes: any = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "staff-manager/staff-summary/open-shift/:id",
        element: (
          <RequireAuth allowedRoles={[ROLES.admin]}>
